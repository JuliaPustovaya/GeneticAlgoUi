...
import static SA.GA.RunAll.getK_MSE;
...
public class Controller implements Initializable {
    ...
    @FXML
    public void getAutogeneratedK(ActionEvent ev) {
        ...
        N = X_list_SA.size();
        GA_K(lineChart2,list2IPredictedData);
...
//K-nearest
    ...
    public static void getFitnessFunctionGAKNearest(int alfaXromocom, int bettaXromocom) {
        //    KCleanStaticVariables.cleanStaticVariables();
        //       SA.SA_main.X_list_SA_EVKLIDOV.clear();
        K = alfaXromocom;
        M = bettaXromocom;
        ...
        System.out.println(getK_MSE(SA_main.X_list_SA_EVKLIDOV, datafromfile, amountForecasting));
        SA_main.X_list_SA_EVKLIDOV.clear();
    }
    ...
    public static double getFitness(int alfa, int beta) {
        K_MSE = 0.0;
        getFitnessFunctionGAKNearest(alfa, beta);
        return K_MSE;
    }
    ...
    public void getInputCoefficientsForecastK(ActionEvent ev) {
        ...
        M = Integer.parseInt(mNearest.getText());
        for (int i = 0; i < datafromfile.size() - amountForecasting; i++) {
            X_list_SA.add(datafromfile.get(i));
        }
        N = X_list_SA.size();
    ...
    public static KXromocoma resKNearestKxromocoma;
    public static void GA_K(LineChart lineChart1,ListView view) {
        ...
        while (K_MSE > 5) {
            ...
            KMutation.RandomMutation(KCrossover.childrenListAfterCrossover);
        ...
        System.out.println("Stop ! mse = "+ K_MSE+" хромосома "+resKNearestKxromocoma);

      //  BuildingCharts.buildChartDouble(lineChart1, datafromfile, forecastResult);
  //   ReflactionDataInListViews.reflactDataIntoListsDouble(view, datafromfile, SA_main.X_list_SA_EVKLIDOV);
