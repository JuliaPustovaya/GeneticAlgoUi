...
public class Population {
    ...
    public static ArrayList<Xromocoma> makeRuletSelection() {
        ...
        for (int i = 0; i < POPULATION; i++) {
            ...
            System.out.println("Fitness Function: "+ new DecimalFormat("#0.0000").format(resultListOfFitness.get(idexOfChoosenXromocoma))+" рандомное число :" + new DecimalFormat("#0.0000").format(randomValue) + ";  номер сектора :  " + idexOfChoosenXromocoma);
