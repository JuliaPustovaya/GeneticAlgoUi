...
public class HoltWintersTripleExponentialImpl {
    ...
    public static ArrayList getHW() {
        ...
        double[] d = forecast(a, 0.2, 0.3, 0.4, 12, 12, true);
        ArrayList<Double> forecastedValues = new ArrayList<>(d.length - a.length);
        for (int i = a.length; i < d.length; i++) {
            forecastedValues.add(d[i]);
        }
